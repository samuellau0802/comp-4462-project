...
const LineChartComponent = ({ country, yearRange, indicator1, indicator2 }) => {
    const chartData = getDataForCountry(country, yearRange, indicator1, indicator2);
            ...
            {chartData.length > 0 ? (
                <ResponsiveContainer width="100%" height={400}>
                    <LineChart data={chartData}>
                        ...
                        <Tooltip />
                        <Legend />
                        <Line type="monotone" dataKey={indicator1} stroke="#8884d8" />
                        <Line type="monotone" dataKey={indicator2} stroke="#82ca9d" />
                    </LineChart>
                </ResponsiveContainer>
            ) : (
